...
import { Chip, Text, FallbackImage, AvatarCircle } from "@components/common";
import useImageError from "@hooks/useImageError";
import { ROUTE_PATHS_MAP } from "@constants/route";
import type { TravelogueResponse } from "@type/domain/travelogue";

interface TravelogueCardProps extends React.ComponentPropsWithRef<"button"> {
...
const getCardAriaLabel = ({
  ...
  TravelogueResponse,
  "title" | "authorNickname" | "likeCount" | "tags"
>) => {
