...
import kr.tour.global.log.dbtrace.QueryExecutionContext;
import kr.tour.global.log.logger.JsonLogger;
import kr.tour.global.log.property.db.DbErrorLogProperty;
import kr.tour.global.log.property.db.SlowQueryLogProperty;
...
public class DbLoggingAspect {
    ...
    @Pointcut("execution(* kr.tour.*.infrastructure..*(..)) ")
