...
public record TraveloguePlaceResponse(
        ...
        public static TraveloguePlaceResponse from(TraveloguePlace traveloguePlace) {
                return TraveloguePlaceResponse.builder()
                        ...
                        .photoUrls(getPhotoUrls(traveloguePlace.getTraveloguePhotos()))
                        .countryCode(traveloguePlace.getCountryCode().name())
                        .build();
        }

        private static List<String> getPhotoUrls(List<TraveloguePhoto> traveloguePhotos) {
                return traveloguePhotos.stream()
